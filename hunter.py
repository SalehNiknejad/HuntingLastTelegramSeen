...
async def command_handler(event):
    ...
    #         if new_interval < 1:
    #             await event.reply("❌ مقدار باید بزرگتر از 0 باشد.")
    #             return
    #         check_interval = new_interval
    #         await event.reply(f"⏲️ بازه زمانی بررسی به {check_interval} ثانیه تغییر کرد.")
    #     except ValueError:
    #         await event.reply("❌ مقدار باید عدد صحیح باشد.")
